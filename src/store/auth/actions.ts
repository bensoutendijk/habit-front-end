...
export const recieveAuth = (payload: LocalUser): AuthActionTypes => {
    return {
        type: RECIEVE_AUTH,
        payload
    }
...
export const loginAuth = (credentials: AuthCredentials): ThunkAction<void, AppState, null, AuthActionTypes> => async (dispatch) => {
    dispatch(requestAuth());
    try {
...
export const createAuth = (credentials: AuthCredentials): ThunkAction<void, AppState, null, AuthActionTypes> => async (dispatch) => {
    dispatch(requestAuth());
    try {
